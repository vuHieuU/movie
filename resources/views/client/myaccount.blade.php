                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="ml-3">
                                    ...
                                    <a href="editaccount" class="btn btn-primary font-size-14">Update</a>
                                </div>
                            </div>
                            <p style="color: #75759D">
                            ...
                            <ul class="list-inline p-0 m-0">
                                <li class="mb-2">
                                    <div class="d-flex align-items-center">
                                        <svg class="svg-icon mr-3" style="color: #75759D" height="16" width="16"
                                        ...
                                        <p class="mb-0" style="color: #75759D" >{{Auth::User()->address}}</p>
                                    </div>
                                </li>
                                <br>
                                <li class="mb-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <p class="mb-0" style="color: #75759D" >{{Auth::User()->gender}}</p>
                                    </div>
                                </li>
                                <br>
                                {{-- <li class="mb-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <p class="mb-0" style="color: #75759D" >March 25</p>
                                    </div>
                                </li>
                                <br> --}}
                                <li class="mb-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <p class="mb-0" style="color: #75759D" >{{Auth::User()->phone}}</p>
                                    </div>
                                </li>
                                <br>
                                <li>
