                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Name"
                                                    data-errors="Please Enter Name." name="name" value="{{ $film->name }}">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Duration"
                                                    data-errors="Please Enter Name." name="duration" value="{{ $film->duration }}">
                                                <div class="help-block with-errors"></div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" placeholder="Expiry Date"
                                                    name="premiere_date" required value="{{ $film->premiere_date }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Name"
                                                    data-errors="Please Enter Name." name="country" value="{{ $film->country }}">
                                                <div class="help-block with-errors"></div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Name"
                                                    data-errors="Please Enter Name." name="trailer" value="{{ $film->trailer }}">
                                                <div class="help-block with-errors"></div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <div class="form-floating">
                                                    ...
                                                    <textarea name="description" id="mySummernote" class="form-control" rows="5">{{ $film->description }}</textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="meta_title" value="{{ $film->meta_title }}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="meta_keyword" value="{{ $film->meta_keyword }}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="meta_description" id="" rows="4" class="form-control">{{ $film->meta_description }}</textarea>
