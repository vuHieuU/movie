...
@section('content')
    <form action="{{ route('films.update', $film->id) }}" method="POST" data-toggle="validator" enctype="multipart/form-data">
        @csrf
        <div class="wrapper">
                            ...
                            <div class="popup text-left">
                                ...
                                <div class="content create-workform bg-body">
                                    <div class="pb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Name or Email" disabled>
                                        @if ($errors->has('name'))
                            ...
                            <div class="card">
                                <div class="card-header d-flex justify-content-between">
                                    <div class="header-title">
                                        <h4 class="card-title">Chi tiết phim phim</h4>
                                    </div>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Name"
                                                    data-errors="Please Enter Name." name="name" value="{{ $film->name }}" disabled>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Duration"
                                                    data-errors="Please Enter Name." name="duration" value="{{ $film->duration }}" disabled>
                                                <div class="help-block with-errors"></div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" placeholder="Expiry Date"
                                                    name="premiere_date" required value="{{ $film->premiere_date }}" disabled>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Name"
                                                    data-errors="Please Enter Name." name="director" value="{{ $film->director }}" disabled>
                                                <div class="help-block with-errors"></div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Name"
                                                    data-errors="Please Enter Name." name="actor" value="{{ $film->actor }}" disabled>
                                                <div class="help-block with-errors"></div>
                                                @if ($errors->has('actor'))
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Name"
                                                    data-errors="Please Enter Name." name="language" value="{{ $film->language }}" disabled>
                                                <div class="help-block with-errors"></div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Name"
                                                    data-errors="Please Enter Name." name="country" value="{{ $film->country }}" disabled>
                                                <div class="help-block with-errors"></div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Name"
                                                    data-errors="Please Enter Name." name="trailer" value="{{ $film->trailer }}" disabled>
                                                <div class="help-block with-errors"></div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                {{-- <input class="form-control" type="file" id="formFile" name="thumb" value="{{ $film->thumb }}" disabled>
                                                @if ($errors->has('thumb'))
                                                <span class="text-danger">{{ $errors->first('thumb') }}</span>

                                                @endif --}}
                                                <div>
                                                    <img src="{{asset('/storage/images/'.$film->thumb)}}" alt="Hình ảnh" style="height: 240px ;width: 240px;">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <div class="form-floating">
                                                    ...
                                                    <textarea name="description" id="mySummernote" class="form-control" rows="5" disabled>{{ $film->description }}</textarea>
