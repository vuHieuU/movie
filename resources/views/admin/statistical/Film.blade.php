                    ...
                    <div class="col-lg-4">
                        <div class="card card-transparent card-block card-stretch card-height border-none">
                            <div class="card-body p-0 mt-lg-2 mt-0">
                                <h3 class="mb-3">Tổng quan về Phim</h3>
                            ...
                            <div class="card-body card-item-right">
                                <div class="d-flex align-items-top">
                                    ...
                                    <div class="style-text text-left">
                                        ...
                                        <p class="mb-0">Tổng đồ ăn trong rạp: {{ $countfood }}</p>
                                        <p class="mb-0">Đồ ăn đã bán: {{ $countfoodsell }}</p>
                    ...
                    <div class="col-lg-8">
                        <div class="card card-block card-stretch card-height">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <div class="header-title">
                                    <h4 class="card-title">Số lượng đồ ăn còn lại</h4>
                                </div>
                            ...
                            <div class="card-body ">
                                <ul class="list-unstyled row top-product mb-0">
                                    ...
                                    @foreach ($countfoodremaining as $item)
                                        <li class="col-lg-3 ">
                                            <div class="card card-block card-stretch card-height mb-0">
                                                <div class="card-body " style="width: 300px;">
                                                    ...
                                                    <div class="style-text text-left mt-3">
                                                        ...
                                                        <p class="mb-0">Số lượng: {{ $item->qty }}</p>
                                        ...
                                        <li class="col-lg-4">
                                            <div class="card card-block card-stretch card-height mb-0">
                                                <div class="card-body">
                                                    ...
                                                    <div class="style-text text-left mt-3 text-center">
