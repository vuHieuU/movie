...
@section('content')
  <form action="{{ route('rank.store') }}" method="POST" data-toggle="validator">
                                    @csrf
        <div class="wrapper">
                            ...
                            <div class="card">
                                <div class="card-header d-flex justify-content-between">
                                    <div class="header-title">
                                        <h4 class="card-title">Thêm cấp bậc</h4>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter score"
                                                    data-errors="Please Enter Name." name="minium_score" required>
                                                <div class="help-block with-errors"></div>
                                            </div>
