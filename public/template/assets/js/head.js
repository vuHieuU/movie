!(function (t, e) {
        ...
        Dt = function (e, n, o) {
            if (o.inputLabel) {
                ...
                i.setAttribute("for", e.id),
                    (i.className = r),
                    "object" === t(o.customClass) &&
                        at(i, o.customClass.inputLabel),
    ...
    function We(t, e) {
        ...
        if (n && t)
            if ("radio" === t.type)
                for (
                    var o = n.querySelectorAll('[name="'.concat(C.radio, '"]')),
                        i = 0;
                    i < o.length;
                    i++
                )
        ...
        Sn = Object.freeze({
            ...
            bindClickHandler: function () {
                (Pn[
                    ...
                    Bn ||
                        (document.body.addEventListener("click", xn),
                        (Bn = !0));
            },
                ...
                o(t, [
                    {
                        ...
                        value: function (t) {
                            ...
                            if (
                                ...
                                var n = ce.swalPromiseResolve.get(
                                        b.currentInstance
                                    ),
                            ...
                            Yn(i),
                                Object.freeze(i),
                                b.timeout &&
                                    (b.timeout.stop(), delete b.timeout),
